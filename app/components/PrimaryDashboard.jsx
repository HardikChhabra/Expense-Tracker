        ...
        <>
            ...
            <div className='my-16 flex flex-row mx-32'>
                ...
                <div className='flex flex-col'>
                    <div>
                        <DashboardTile text={'Balance'} value={5000} percentage={20.5} primaryColor={'rgb(96 165 250)'} secondaryColor={'rgb(219 234 254)'} />
                        <DashboardTile text={'Expense'} value={1000} percentage={2.5} primaryColor={'rgb(248 113 113)'} secondaryColor={'rgb(254 226 226)'} />
                        <DashboardTile text={'Income'} value={6000} percentage={50.0} primaryColor={'rgb(74 222 128)'} secondaryColor={'rgb(220 252 231)'} />
                    </div>
                    <div className='flex flex-row' data-modal-target="crud-modal" data-modal-toggle="crud-modal">
            ...
            <div id="crud-modal" tabindex="-1" aria-hidden="true" className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <AddTransactionForm handleSubmit={() => { }} username={usernameRef} balance={balance} income={income} />
